...
const Home = () => {
    ...
    return (
        ...
        {projectList?.map((project, i) => (
          ...
          <Radio onChange={(e) => setProject(e.target.value)}  id="permission" name="countries" value={project?.PROJECT_ID}  />
          <Label htmlFor="permission">{'Project-'+project?.PROJECT_ID}</Label>
          </div>
          ))}
      </div> 
      }        
